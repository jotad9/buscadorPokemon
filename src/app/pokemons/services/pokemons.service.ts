...
export class PokemonsService {
  ...
  private getPokemonsRequest(url: string): Observable<Result[]> {
    return this.httpClient.get<Pokemon>(url).pipe(map((data) => data.results,),
      catchError(() => of([]))
  ...
  searchTipo(term: string): Observable<Result[]> {
  ...
  searchRegion(term: string): Observable<Result[]> {
  ...
  searchNombre(term: string): Observable<Result[]> {
